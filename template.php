 ...
 *   ngstark_. For example:
 *
 *     original, found in modules/field/field.module: theme_field()
 *     theme override, found in template.php: ngstark_field()
 *
 *   where ngstark is the name of your sub-theme. For example, the
...
function ngstark_preprocess_maintenance_page(&$variables, $hook) {
  // When a variable is manipulated or added in preprocess_html or
  // preprocess_page, that same work is probably needed for the maintenance page
  // as well, so we can just re-use those functions to do that work here.
  ngstark_preprocess_html($variables, $hook);
  ngstark_preprocess_page($variables, $hook);
}
// */
 ...
 */
function ngstark_preprocess_html(&$variables, $hook) {
 ...
 *   The name of the template being rendered ("html" in this case.)
 */
function ngstark_process_html(&$variables, $hook) {
...
function ngstark_preprocess_page(&$variables, $hook) {
  ...
  drupal_add_js('/sites/all/themes/ngstark/js/controllers.js','file');
  drupal_add_js('/sites/all/themes/ngstark/js/filters.js','file');
  drupal_add_js('/sites/all/themes/ngstark/js/directives.js','file');
 ...
 */
/* -- Delete this line if you want to use this function
function ngstark_preprocess_node(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');

  // Optionally, run node-type-specific preprocess functions, like
  // ngstark_preprocess_node_page() or ngstark_preprocess_node_story().
 ...
 */
/* -- Delete this line if you want to use this function
function ngstark_preprocess_comment(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function ngstark_preprocess_region(&$variables, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function ngstark_preprocess_block(&$variables, $hook) {
